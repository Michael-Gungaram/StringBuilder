...
namespace IntechCode.Tests
{
    ...
    public class EncodingTests
    {
        ...
        public void encoding_is_all_about_text_to_byte_and_byte_to_test()
        {
            ...
            string sA = "ممدون";
            char[] c = { '\u2649', '\u0070', '\u00c0', '\u00d0'};
            var bytesUTF16sec = Encoding.Unicode.GetBytes(c);
            var bytesToChars = Encoding.Unicode.GetChars(bytesUTF16sec);

            char fafou = Convert.ToChar('\u2649');
            string f = "\u2649";
            var fBytes = Encoding.Unicode.GetBytes(f);
